...
(Figure~\ref{fig:src-bkg-fits}, Table~\ref{tab:src-fit}), as fits with solar
...
\begin{table*}[!ht]
    ...
    \caption{Integrated source and background fits, single-temperature NEI
        model with non-solar abundances \label{tab:src-fit}}
    \footnotesize
...
source fit with Mg, Si, S free (Table~\ref{tab:src-fit}).  % TODO may change...
