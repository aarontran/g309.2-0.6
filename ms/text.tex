...
Degeneracy in our fits (e.g., with soft proton contamination) limits our
ability to constrain X-ray background parameters further.
...
These variations are small and of order $20$--$50\%$, and may be insignificant
compared to errors from systematic assumptions.
But, these variations are consistent with the standard picture of supernova
remnant acceleration, wherein recently shocked ISM and central reverse-shocked
central ejecta should be the ``youngest'' emitting plasma.
