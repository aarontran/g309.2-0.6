...
\begin{figure*}[]
    ...
    integrated source and background regions.}
    \label{fig:src-bkg-regs}  % TODO this must follow figcaption, forgot why
\end{figure*}
...
\begin{figure*}[]
    ...
    \figcaption{Unsmoothed 0.8--3.3 keV image of SNR G309.2-0.6 with
    integrated source and background regions.}
    \label{fig:fiveann-regs}  % TODO this must follow figcaption, forgot why
\end{figure*}
...
(2) the fit shows some soft excess, which can / cannot \textbf{???} % TODO
