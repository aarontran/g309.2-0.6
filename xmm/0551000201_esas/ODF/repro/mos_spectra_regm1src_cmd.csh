     # Limit=1.0 CCD=2 Hardness=5.083 Uncertainty=0.803
     # Limit=1.0 CCD=3 Hardness=5.697 Uncertainty=1.075
     # Limit=1.40 CCD=4 Hardness=3.217 Uncertainty=0.404
     # Limit=2.00 CCD=5 Hardness=3.909 Uncertainty=0.467
     # Limit=1.0 CCD=6 Hardness=0.000 Uncertainty=0.000 ****
     # Limit=1.0 CCD=7 Hardness=6.000 Uncertainty=0.935
     # Limit=1.0 CCD=2 Hardness=4.203 Uncertainty=0.563
     # Limit=1.0 CCD=3 Hardness=6.075 Uncertainty=1.037
     # Limit=1.0 CCD=4 Hardness=8.463 Uncertainty=1.398
     # Limit=1.70 CCD=5 Hardness=0.705 Uncertainty=0.049 ****
     # Limit=1.0 CCD=6 Hardness=5.650 Uncertainty=0.969
     # Limit=1.0 CCD=7 Hardness=4.772 Uncertainty=0.695
# CCD designated as being in an anomolous state: ****
# CCD possibly in an anomolous state (within 1 sigma): ####
evselect table=mos1S001-clean.fits:EVENTS withfilteredset=yes expression='(PATTERN<=12)&&(FLAG == 0) &&((CCDNR == 1)||(CCDNR == 2)||(CCDNR == 3)||(CCDNR == 4)||(CCDNR == 5)||(CCDNR == 7)) &&(PI in [300:8000])' filtertype=expression imagebinning='imageSize' imagedatatype='Int32' imageset=mos1S001-obj-im.fits squarepixels=yes ignorelegallimits=yes withxranges=yes withyranges=yes xcolumn='X' ximagesize=900 ximagemax=48400 ximagemin=3401 ycolumn='Y' yimagesize=900 yimagemax=48400 yimagemin=3401 updateexposure=yes filterexposure=yes
   
evselect table=mos1S001-clean.fits:EVENTS withfilteredset=yes expression='(PATTERN<=12)&&(FLAG == 0)&&(((DETX,DETY) IN box(-2683.5,-15917,2780.5,1340,0))||((DETX,DETY) IN box(2743.5,-16051,2579.5,1340,0))||((DETX,DETY) IN circle(97,-172,17152)))&&!((DETX,DETY) in BOX(-13169,-105,6599,6599,0)) &&((DETX,DETY) IN circle(-4650.2, -2784.3, 4795.2))' filtertype=expression imagebinning='imageSize' imagedatatype='Int32' imageset=mos1S001-obj-im-sp-det.fits squarepixels=yes ignorelegallimits=yes withxranges=yes withyranges=yes xcolumn='DETX' ximagesize=780 ximagemax=19500 ximagemin=-19499 ycolumn='DETY' yimagesize=780 yimagemax=19500 yimagemin=-19499 updateexposure=yes filterexposure=yes
...
evselect table=/data/mpofls/atran/research/xmm/caldb/mos1-fwc.fits.gz:EVENTS withfilteredset=yes expression='(PATTERN<=12)&&(FLAG == 0)&&((DETX,DETY) in BOX(20,-60,6610,6570,0))&&!((DETX,DETY) in BOX(-13169,-105,6599,6599,0)) &&(((DETX,DETY) IN box(-2683.5,-15917,2780.5,1340,0))||((DETX,DETY) IN box(2743.5,-16051,2579.5,1340,0))||((DETX,DETY) IN circle(97,-172,17152)))&&((DETX,DETY) IN circle(-4650.2, -2784.3, 4795.2))' withspectrumset=yes spectrumset=mos1S001-1ff.pi energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=11999
...
evselect table=/data/mpofls/atran/research/xmm/caldb/mos1-fwc.fits.gz:EVENTS withfilteredset=yes expression='(FLAG == 0)&&((DETX,DETY) IN circle(-4650.2, -2784.3, 4795.2))&&(((DETX,DETY) IN box(-2683.5,-15917,2780.5,1340,0))||((DETX,DETY) IN box(2743.5,-16051,2579.5,1340,0))||((DETX,DETY) IN circle(97,-172,17152)))&&((DETX,DETY) in BOX(6550,-13572,6590,6599,0))&&!((DETX,DETY) in BOX(-13169,-105,6599,6599,0)) ' withspectrumset=yes keepfilteroutput=no updateexposure=yes filterexposure=yes spectrumset=mos1S001-2ff.pi energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=11999 
...
evselect table=/data/mpofls/atran/research/xmm/caldb/mos1-fwc.fits.gz:EVENTS withfilteredset=yes expression='(FLAG == 0)&&((DETX,DETY) IN circle(-4650.2, -2784.3, 4795.2))&&(((DETX,DETY) IN box(-2683.5,-15917,2780.5,1340,0))||((DETX,DETY) IN box(2743.5,-16051,2579.5,1340,0))||((DETX,DETY) IN circle(97,-172,17152)))&&((DETX,DETY) in BOX(13280,-306,6610,6599,0))&&!((DETX,DETY) in BOX(-13169,-105,6599,6599,0)) ' withspectrumset=yes keepfilteroutput=no updateexposure=yes filterexposure=yes spectrumset=mos1S001-3ff.pi energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=11999 
...
evselect table=/data/mpofls/atran/research/xmm/caldb/mos1-fwc.fits.gz:EVENTS withfilteredset=yes expression='(FLAG == 0)&&((DETX,DETY) IN circle(-4650.2, -2784.3, 4795.2))&&(((DETX,DETY) IN box(-2683.5,-15917,2780.5,1340,0))||((DETX,DETY) IN box(2743.5,-16051,2579.5,1340,0))||((DETX,DETY) IN circle(97,-172,17152)))&&((DETX,DETY) in BOX(6700,13070,6530,6560,0))&&!((DETX,DETY) in BOX(-13169,-105,6599,6599,0)) ' withspectrumset=yes keepfilteroutput=no updateexposure=yes filterexposure=yes spectrumset=mos1S001-4ff.pi energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=11999 
...
evselect table=/data/mpofls/atran/research/xmm/caldb/mos1-fwc.fits.gz:EVENTS withfilteredset=yes expression='(FLAG == 0)&&((DETX,DETY) IN circle(-4650.2, -2784.3, 4795.2))&&(((DETX,DETY) IN box(-2683.5,-15917,2780.5,1340,0))||((DETX,DETY) IN box(2743.5,-16051,2579.5,1340,0))||((DETX,DETY) IN circle(97,-172,17152)))&&((DETX,DETY) in BOX(-6410,13130,6570,6560,0))&&!((DETX,DETY) in BOX(-13169,-105,6599,6599,0)) ' withspectrumset=yes keepfilteroutput=no updateexposure=yes filterexposure=yes spectrumset=mos1S001-5ff.pi energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=11999 
...
evselect table=/data/mpofls/atran/research/xmm/caldb/mos1-fwc.fits.gz:EVENTS withfilteredset=yes expression='(FLAG == 0)&&((DETX,DETY) IN circle(-4650.2, -2784.3, 4795.2))&&(((DETX,DETY) IN box(-2683.5,-15917,2780.5,1340,0))||((DETX,DETY) IN box(2743.5,-16051,2579.5,1340,0))||((DETX,DETY) IN circle(97,-172,17152)))&&((DETX,DETY) in BOX(-6540,-13438,6570,6599,0))&&!((DETX,DETY) in BOX(-13169,-105,6599,6599,0)) ' withspectrumset=yes keepfilteroutput=no updateexposure=yes filterexposure=yes spectrumset=mos1S001-7ff.pi energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=11999 
